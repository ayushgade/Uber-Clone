...
export default function Home() {
  return (
    <Wrapper>
      ...
      <ActionItems>
      <Header>
        <UderLogo src = 'https://i.ibb.co/84stgjq/uber-technologies-new-20218114.jpg' />
        <Profile>
          <Name>Ayush Gade</Name>
          <UserImage 
...
bg-gray-200 flex-1 m-1 h-32 flex flex-col items-center
rounded-lg transform hover:scale-105 transition text-xl cursor-pointer
`
...
// ** To go to different pages next js makes it easy
